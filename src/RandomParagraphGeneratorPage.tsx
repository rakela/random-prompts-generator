...
const promptData = {
  paragraphs: {
    ...
    narrative: [
      ...
      'He woke to find himself in a room he didn\'t recognize, with no memory of how he got there. On the nightstand, a note in his own handwriting read: "Trust no one, not even yourself."',
    ...
    expository: [
      ...
      'The concept of democracy traces it\'s roots to ancient Greece, where citizens gathered to debate and vote on matters of state. While modern democratic systems have evolved significantly, they still embody the fundamental principle that government derives it\'s authority from the consent of the governed.',
    ...
    creative: [
      ...
      'Mirrors didn\'t reflect reality but showed possibilities – parallel versions of the viewer, each one having made different choices, living different lives. Most people simply saw what they expected to see.'
    ],
    dialogue: [
      ...
      '"The data doesn\'t lie," Marcus insisted, spreading the documents across the table. "Someone in this room is the leak, and I intend to find out who." The silence that followed was deafening.',
      '"You don\'t understand," she said, gripping the steering wheel tighter. "If we turn back now, everything we\'ve worked for-" "I understand perfectly," he interrupted. "The question is, do you?"',
      ...
      '"This is impossible," the scientist muttered, checking her calculations for the third time. Her assistant looked over her shoulder and gasped. "It\'s not impossible," he said slowly. "It\'s just highly improbable. And it\'s happening anyway."',
      ...
      '"Do you ever wonder," he asked, staring up at the stars, "if we\'re looking at the same thing everyone else sees?" She considered this. "I think we all see something slightly different, and that\'s okay."',
...
const RandomParagraphGeneratorPage = () => {
  ...
  const [savedPrompts, setSavedPrompts] = useLocalStorage('paragraph-saved-prompts', []);
  const [promptHistory, setPromptHistory] = useLocalStorage('paragraph-prompt-history', []);
  const [favorites, setFavorites] = useLocalStorage('paragraph-favorites', []);
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {showHistory && (
            <div className="mt-8 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 shadow-sm transition-colors">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Recent Paragraphs</h3>
                    ...
                    <div key={prompt.id} className="bg-gray-50 rounded-lg p-3 border border-gray-100">
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1">
                          <p className="text-sm text-gray-800 dark:text-gray-200 leading-relaxed line-clamp-3">{prompt.text}</p>
          ...
          <div className="mt-16 space-y-8">
            <div className="prose prose-gray max-w-none">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Random Paragraph Generator</h2>
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Example Random Paragraphs:</h3>
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">What is a random paragraph generator?</h3>
              ...
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Can I use generated paragraphs in my writing projects?</h3>
                <p className="text-gray-700 dark:text-gray-300">
              ...
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">What paragraph types can I generate?</h3>
                <p className="text-gray-700 dark:text-gray-300">
              ...
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">How can random paragraphs help with writing practice?</h3>
                <p className="text-gray-700 dark:text-gray-300">
