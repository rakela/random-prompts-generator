...
const RandomPhotographyPromptGeneratorPage = () => {
  ...
  const generatePrompt = useCallback(() => {
    ...
    const prompt = { id: Date.now(), text: batchSize === 1 ? items[0] : items.join('\n\n'), category: 'randomphotographypromptgenerator', timestamp: new Date().toISOString(), isMultiple: batchSize > 1 };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      <SEO pageKey="randomPhotographyPromptGenerator" />
      ...
      <div className="bg-gradient-to-r from-slate-600 to-gray-600 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Random Photography Prompt Generator</h1>
          <p className="text-lg opacity-80 mb-8 max-w-2xl mx-auto">Generate photography prompts with composition, lighting, and subject ideas.</p>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 space-y-8">
            <div className="prose prose-gray max-w-none">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Random Photography Prompt Generator</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">Generate photography prompts with composition, lighting, and subject ideas.</p>
            </div>
          </div>
        </div>
...
export default RandomPhotographyPromptGeneratorPage;
