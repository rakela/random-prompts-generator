...
const promptData = {
  sentences: {
    ...
    descriptive: [
      ...
      'The ocean stretched endlessly, its surface glittering like scattered diamonds.',
    ...
    poetic: [
      ...
      'The night sky held infinite possibilities in its velvet embrace.',
      ...
      'The river remembered every stone it had smoothed along its journey.',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {showHistory && (
            <div className="mt-8 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 shadow-sm transition-colors">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Recent Sentences</h3>
          ...
          {savedPrompts.length > 0 && (
            <div className="mt-12">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Saved Sentences</h3>
          ...
          <div className="mt-16 space-y-8">
            <div className="prose prose-gray max-w-none">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Random Sentence Generator</h2>
