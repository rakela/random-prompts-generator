...
const promptData = {
  sentences: {
    ...
    humor: [
      ...
      'The meeting that could have been an email stretched into its third hour.',
      'His dance moves suggested someone fighting invisible bees.',
      'The WiFi password was changed, bringing civilization to its knees.',
    ...
    poetic: [
      ...
      'The wind carried secrets between the branches of sleeping trees.',
