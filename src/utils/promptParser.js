// Random Prompts Parser - Extracted from Chrome Extension
// This module provides prompt data and generation utilities for the main application
...
export const processTemplate = (template, data, category) => {
  if (category === 'names') {
...
export const enhancePrompt = (prompt, category) => {
  const enhancements = {
    writing: [
...
export const generatePrompt = (category) => {
