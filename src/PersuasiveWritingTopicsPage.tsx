  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      <Helmet>
        ...
        <meta name="description" content="Discover engaging persuasive writing topics for students covering school, environment, technology, and ethics. Perfect for essays, debates, classroom discussions, and developing critical thinking skills." />
        ...
        <meta property="og:description" content="Discover engaging persuasive writing topics for students covering school, environment, technology, and ethics. Perfect for essays, debates, and classroom discussions." />
        ...
        <meta name="twitter:description" content="Discover engaging persuasive writing topics for students covering school, environment, technology, and ethics." />
      </Helmet>
          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <div className="relative group">
                <button className="text-gray-600 hover:text-orange-600 transition-colors flex items-center gap-1">
                  Prompts
                ...
                <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  ...
                  <Link to="/persuasive-writing-topics" className="block px-4 py-3 text-gray-700 hover:bg-orange-50 border-b border-gray-100">
              ...
              <a href="https://github.com/rakela/random-prompts-generator" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-gray-600 hover:text-orange-600 transition-colors">
                <Github size={16} />
                GitHub
              </a>
              <button
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm mb-4">
                Free persuasive writing topics and debate ideas for students, teachers, and educational inspiration.
              </p>
              <div className="flex space-x-4">
                ...
                <a href="https://twitter.com/intent/tweet?text=Check%20out%20these%20persuasive%20writing%20topics!&url=https://randomprompts.org/persuasive-writing-topics" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                  <Twitter size={20} />
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="https://www.debate.org" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">Debate.org</a></li>
                <li><a href="https://owl.purdue.edu/owl/general_writing/academic_writing/essay_writing/argumentative_essays.html" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">Purdue OWL</a></li>
              </ul>
            </div>
