        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 space-y-8">
            <div className="prose prose-gray max-w-none">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Random Fantasy Art Prompt Generator</h2>
              <p className="text-gray-700 mb-4">Generate fantasy art prompts with magical creatures and mystical scenes.</p>
            </div>
          </div>
        </div>
