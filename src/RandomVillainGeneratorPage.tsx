...
const promptData = {
  villains: {
    ...
    methods: ['manipulation and deception', 'overwhelming force and brutality', 'subtle corruption from within', 'exploiting peoples fears', 'using advanced technology', 'wielding dark magic', 'controlling minds', 'economic domination', 'political maneuvering', 'creating false flag operations'],
    traits: ['charismatic and persuasive', 'cold and calculating', 'volatile and unpredictable', 'methodical and patient', 'sadistic and cruel', 'tragic and sympathetic', 'brilliantly intelligent', 'driven by obsession', 'ruthlessly pragmatic', 'convinced theyre the hero'],
    weaknesses: ['their pride and arrogance', 'an emotional attachment', 'overconfidence in their plan', 'underestimating their opponents', 'a physical vulnerability', 'their own past haunting them', 'loyalty to someone who betrays them', 'inability to adapt', 'their humanity despite their actions', 'a moral line they wont cross'],
