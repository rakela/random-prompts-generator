...
const RandomVillainGeneratorPage = () => {
  ...
  const [savedPrompts, setSavedPrompts] = useLocalStorage('random-villain-generator-saved-prompts', []);
  const [promptHistory, setPromptHistory] = useLocalStorage('random-villain-generator-prompt-history', []);
  const [favorites, setFavorites] = useLocalStorage('random-villain-generator-favorites', []);
