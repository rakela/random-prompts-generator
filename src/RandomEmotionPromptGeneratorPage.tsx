        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 space-y-8">
            <div className="prose prose-gray max-w-none">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Random Emotion Prompt Generator</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">Generate emotion prompts for character development and emotional depth in writing.</p>
            </div>
          </div>
        </div>
