...
const promptData = {
  characters: {
    ...
    skills: ['expert hacker', 'master of disguise', 'multilingual negotiator', 'skilled martial artist', 'brilliant strategist', 'gifted mechanic', 'talented con artist', 'exceptional tracker', 'medical expert', 'supernatural ability they cant control'],
