  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-pink-50">
      <Helmet>
        ...
        <meta name="description" content="Discover unique nano banana prompts for AI image generation. Browse 96+ creative prompts across 8 categories including 3D figurines, plush toys, capsule dioramas, portraits, synthwave art, and more. Perfect for AI artists and creators." />
        ...
        <meta property="og:description" content="Discover unique nano banana prompts for AI image generation. Browse 96+ creative prompts across 8 categories. Perfect for AI artists and creators." />
        ...
        <meta name="twitter:description" content="Discover unique nano banana prompts for AI image generation. Browse 96+ creative prompts across 8 categories." />
      </Helmet>
          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <div className="relative group">
                <button className="text-gray-600 hover:text-yellow-600 transition-colors flex items-center gap-1">
                  Prompts
              ...
              <a href="https://github.com/rakela/random-prompts-generator" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-gray-600 hover:text-yellow-600 transition-colors">
                <Github size={16} />
                GitHub
              </a>
              <button
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm mb-4">
                Free nano banana prompts and AI image generation ideas for creative artists and AI enthusiasts.
              </p>
              <div className="flex space-x-4">
                ...
                <a href="https://twitter.com/intent/tweet?text=Check%20out%20these%20nano%20banana%20prompts!&url=https://randomprompts.org/nano-banana-prompts" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                  <Twitter size={20} />
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="https://openai.com/dall-e-3" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">DALL-E 3</a></li>
